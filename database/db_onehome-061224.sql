...
--
ALTER TABLE `bs_user`
  MODIFY `user_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1190;
...
--
ALTER TABLE `tbl_independent`
  MODIFY `in_id` int(55) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tr_login_attempt`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=705;
COMMIT;
