...
CREATE DATABASE IF NOT EXISTS `db_onehome` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `db_onehome`;
...
CREATE TABLE IF NOT EXISTS `bs_user` (
  ...
  `is_test` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1191 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='sub category for independent service provider';

-- Dumping data for table db_onehome.ind_maincat: ~14 rows (approximately)
DELETE FROM `ind_maincat`;
...
CREATE TABLE IF NOT EXISTS `ind_subcat` (
  ...
  KEY `main_id` (`main_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='main category of independent service provider';

-- Dumping data for table db_onehome.ind_subcat: ~6 rows (approximately)
DELETE FROM `ind_subcat`;
...
CREATE TABLE IF NOT EXISTS `tr_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=175 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table db_onehome.tr_log: 174 rows
DELETE FROM `tr_log`;
...
CREATE TABLE IF NOT EXISTS `tr_login_attempt` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=721 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table db_onehome.tr_login_attempt: 720 rows
