...
-- Dumping structure for table db_onehome.tbl_balance
CREATE TABLE IF NOT EXISTS `tbl_balance` (
  `bal_id` int(100) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table db_onehome.tbl_balance: ~1 rows (approximately)
