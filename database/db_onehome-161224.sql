...
-- Dumping data for table db_onehome.ind_maincat: ~13 rows (approximately)
...
-- Dumping data for table db_onehome.tbl_company: ~1 rows (approximately)
...
-- Dumping data for table db_onehome.tbl_position: ~0 rows (approximately)
...
-- Dumping data for table db_onehome.tr_log: 170 rows
DELETE FROM `tr_log`;
...
-- Dumping data for table db_onehome.tr_login_attempt: 719 rows
