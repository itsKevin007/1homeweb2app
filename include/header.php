...
?>
<link rel="stylesheet" href="<?php echo WEB_ROOT; ?>style/right-menu.css">
...
<div class="offcanvas-right">
        <nav><br><br>
			<div class="drawer-header drawer-header-cover" >
				...
				<a href="<?php echo $profileDirect ?>" style="text-decoration: none; color: inherit;">
					<div class="drawer-user" style="position: relative; z-index: 1; display: flex; align-items: center; gap: 15px; padding: 10px;">
						<div style="flex-shrink: 0;">
							<img src="<?php echo $image; ?>" id="img-preview" style="width: 60px; height: 60px; border-radius: 50%; object-fit: cover;">
						</div>
						<div class="drawer-meta" style="flex-grow: 1;">
							<h6 style="margin: 0; font-size: 1.1rem; font-weight: 500;"><?php echo $name; ?></h6>
							<!-- You can add additional user info here if needed -->
							<!-- <small style="color: #666; font-size: 0.9rem;">user@email.com</small> -->
						</div>
					</div>
				</a>
			</div>
		...
		<nav class="drawer-navigation drawer-border">
			...
			<?php }else{} ?>
				...
				<a href="<?php echo WEB_ROOT; ?>settings/">
					<div class="app-setting-menu-start mt-16">
						<div class="menu-icon">
							<img src="<?php echo WEB_ROOT; ?>assets/images/icon/cog-white.svg" iewBox="0 0 24 24" alt="logo" width="24" height="24">
						</div>
						<div class="menu-txt-app">
							<h3 class="app-txt-title">Settings</h3>
						</div>
					</div>
					<div class="border-bottom-app mt-8"></div>
				</a>
...
<script>
	...
	const offcanvas = document.querySelector('.offcanvas-right');
