...
function delete_data()
{
	...
	$sql = $conn->prepare("UPDATE tbl_independent SET is_deleted = '1', date_deleted = '$today_date1', deleted_by = '$userId' WHERE uid = '$id'");
	$sql->execute();

	$log = $conn->prepare("INSERT INTO tr_log (module, action, description, action_by, log_action_date)
											VALUES ('Independent', 'Independent Service Provider Deleted', '$keyword', '$userId', '$today_date1')");
	$log->execute();	
