...
if($chk->rowCount() > 0)
{
    header('Location: ../sign-up.php?mail=exist');              
		...
		$bsUser = $conn->prepare("INSERT INTO bs_user (firstname, middlename, lastname, email, username, contactno, password, access_level) 
												VALUES (:fname, :mname, :lname, :emailadd, :emailadd, :connum, md5(:password), '1')");
		...
		$sql = $conn->prepare("INSERT INTO tbl_independent (user_id, fname, mname, lname, suffix, emailadd, connum,
